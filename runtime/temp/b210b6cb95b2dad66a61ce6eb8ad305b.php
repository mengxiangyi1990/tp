<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/sale\index.html";i:1507442646;}*/ ?>
...
<div class="main">
        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <?php if(!(empty($lease) || (($lease instanceof \think\Collection || $lease instanceof \think\Paginator ) && $lease->isEmpty()))): if(is_array($lease) || $lease instanceof \think\Collection || $lease instanceof \think\Paginator): $i = 0; $__LIST__ = $lease;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="<?php echo $channel['logo']; ?>" alt="...">
                                <div class="caption">
                                    <h4><?php echo $channel['title']; ?></h4>
                                    <p class="zushouInfo"><?php echo $channel['description']; ?></p>
                                    <p class="text-danger"><?php echo $channel['price']; ?><?php echo !empty($channel['unit'])?"元/月" : ""; ?></p>
                                    <p><a href="<?php echo url('show?id='.$channel['id']); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    <div class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            <?php if(!(empty($sell) || (($sell instanceof \think\Collection || $sell instanceof \think\Paginator ) && $sell->isEmpty()))): if(is_array($sell) || $sell instanceof \think\Collection || $sell instanceof \think\Paginator): $i = 0; $__LIST__ = $sell;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$channel): $mod = ($i % 2 );++$i;?>
                            <div class="col-xs-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="/Uploads/Picture/2017-03-08/58bf763484dfa.png" alt="...">
                                    <div class="caption">
                                        <h4><?php echo $channel['title']; ?></h4>
                                        <p class="zushouInfo"><?php echo $channel['description']; ?></p>
                                        <p class="zushouInfo"><?php echo $channel['descrition']; ?></p>
                                        <p class="text-danger"><?php echo $channel['price']; ?><?php echo !empty($channel['unit'])?"万元":""; ?></p>
                                        <p><a href="<?php echo url('show?id='.$channel['id']); ?>" class="btn btn-danger zushouBtn">详细信息</a> </p>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="think_page_trace_tab" style="display: none;background:white;margin:0;height: 250px;">
        ...
        <div id="think_page_trace_tab_cont" style="overflow:auto;height:212px;padding: 0; line-height: 24px">
            ...
            <div style="display:none;">
                <ol style="padding: 0; margin:0">
                    <li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px">SHOW COLUMNS FROM `channel` [ RunTime:0.0004s ]</li><li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px">SELECT * FROM `channel` WHERE `pid` = 0 ORDER BY `sort` asc  [ RunTime:0.0001s ]</li><li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px">SHOW COLUMNS FROM `sale` [ RunTime:0.0004s ]</li><li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px">SELECT * FROM `sale` WHERE `type` = 1  [ RunTime:0.0002s ]</li><li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px">SELECT * FROM `sale` WHERE `type` = 2  [ RunTime:0.0002s ]</li>    </ol>
            </div>
            <div style="display:none;">
                <ol style="padding: 0; margin:0">
                </ol>
