...
<div class="data-table table-striped">
    <table class="">
        ...
        <tr>
            ...
            <td><?php echo !empty($vo['type']) && $vo['type']==1?'出售' :'出租'; ?></td>
            <td><?php echo $vo['price']; ?><?php echo !empty($vo['unit']) && $vo['unit']==1?'元/月':'万元'; ?></td>
            <td><span><?php echo time_format($vo['create_time']); ?></span></td>
            <td><span><?php echo time_format($vo['end_time']); ?></span></td>
            <td><?php echo $vo['status']; ?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$vo['id']); ?>">编辑</a>
